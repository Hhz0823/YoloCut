...
export function resolveRenderConcurrency({
  ...
  override = process.env.YOLOCUT_RENDER_CONCURRENCY,
} = {}) {
...
export function remotionHardwareAcceleration(codec, {
  ...
  disabled = /^(?:1|true|yes)$/i.test(process.env.YOLOCUT_DISABLE_HARDWARE_ENCODING ?? ''),
  encoder,
} = {}) {
...
export function h264FfmpegOverride(encoder, {
  vaapiDevice = process.env.YOLOCUT_VAAPI_DEVICE,
} = {}) {
