...
async function beginAppliedSession(context: SessionVerifierContext): Promise<AppliedSession> {
  const client = await targetClient(context, 'yolocut-mcp-manual-applied');
...
async function verifyCrossOwnerRejection(
  ...
  const intruder = await targetClient(context, 'yolocut-mcp-session-intruder');
...
async function beginOwnedDiscard(
  ...
  const client = await targetClient(context, 'yolocut-mcp-discard-owner');
...
async function beginRejectedSession(context: SessionVerifierContext): Promise<AppliedSession> {
  const client = await targetClient(context, 'yolocut-mcp-manual-rejected');
...
async function beginStaleDiscard(
  ...
  const client = await targetClient(context, 'yolocut-mcp-stale-discard-owner');
