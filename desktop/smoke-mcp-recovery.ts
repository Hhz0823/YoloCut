...
// The embedded server installs a global outbound ProxyAgent for provider
// requests. MCP recovery traffic is loopback-only and must stay direct, just
// like the other packaged desktop smoke probes.
