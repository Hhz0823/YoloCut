...
const CHANGED_UPLOADS = resolve('/changed');
const HASH_A = 'aa'.repeat(32);
const HASH_B = 'bb'.repeat(32);
const cleanupPaths = (directory: string, stem = 'id'): string[] => [
  join(directory, `${stem}.mov`),
...
assert.deepEqual(
  ...
  new Set([...cleanupPaths(UPLOADS), ...cleanupPaths(CHANGED_UPLOADS)]),
