...
// Graphite keeps its historical id for stored preferences, but is now the
// binding macOS Vibrancy default described in DESIGN.md.
const GRAPHITE: SkinTokens = {
  bg: '#1c1c1e', inset: '#1c1c1e', panel: '#2c2c2e', panelAlt: '#3a3a3c', hover: '#3a3a3c',
  border: '#404043', borderLight: '#48484a',
  text: '#f2f2f3', textMuted: '#c4c4c5', textDim: '#98989a', textStrong: '#f2f2f3',
  accent: '#0a84ff', accentDeep: '#0077ed', accentRgb: '10,132,255', onAccent: '#ffffff',
  inkRgb: '255,255,255', shadowRgb: '0,0,0', colorScheme: 'dark',
  gold: '#ff9f0a', select: '#0a84ff', success: '#30d158', danger: '#ff453a',
  tlTrack: '#1c1c1e', tlSidePanel: '#2c2c2e',
...
export const SKINS: readonly SkinDef[] = [
  { id: 'graphite', nameZh: 'macOS 毛玻璃', tokens: GRAPHITE },
  {
  ...
  // Catppuccin Latte: official light color (blue-gray neutral, non-cream beige), accent = peach orange
  {
    ...
    tokens: {
      ...
      // Under light color, 1px thin lines need to be deeper to be readable: border=surface2, borderLight=overlay1 (official level)
