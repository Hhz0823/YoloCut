...
Use this workflow when the user wants YoloCut to create a cinematic AI-generated short film or story-led visual sequence.

This is a YoloCut-native workflow. If a source workflow depends on external image/video generation or manual assembly, replace that step with YoloCut's equivalent capability when available. Do not add unrelated YoloCut features just because they exist.
...
- Replace external generation or assembly steps with equivalent YoloCut capabilities when they exist. Do not introduce unrelated YoloCut features just because they are available.
