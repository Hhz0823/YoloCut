---
name: verification
description: Use when checking whether agent edits are reflected in the YoloCut project and editor.
---
...
Use `view_timeline_frames` for composed timeline proof. This verifies the edited YoloCut timeline: trims, layers, captions, effects,
...
If both visual proof paths are blocked, ask the user to inspect the YoloCut
