---
name: known-errors
description: Use when a YoloCut tool call fails or returns an unexpected shape.
---
...
- Use `import_media action=create_session`, then run the YoloCut media import helper once with the returned token for client-held files.
...
- Rerun the YoloCut media import helper; it owns frontend-aligned conversion and will surface a user-actionable error if conversion is impossible.
...
- MG code must pass the YoloCut validator.
