...
4. **Create it** with `manage_skill action=create`. The tool reports the
   install path (`~/.yolocut/skills/<slug>/SKILL.md`).
...
- Reference existing YoloCut tools by their exact tool names
...
## Progressive disclosure in YoloCut
