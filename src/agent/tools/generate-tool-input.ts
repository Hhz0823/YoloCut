...
const localVoice = (args: GenerateArgs): SubmitVoiceArgs => ({
  ...voiceBase(args, 'local'),
  modelId: str(args.modelId),
  languageCode: str(args.languageCode),
  speed: num(args.speed),
  devicePreference: args.devicePreference === 'auto' || args.devicePreference === 'webgpu'
    || args.devicePreference === 'cuda' || args.devicePreference === 'cpu'
    ? args.devicePreference
    : undefined,
});
