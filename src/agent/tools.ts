...
import {
  AUTO_EDIT_BATCH_TOOL_NAMES,
  AUTO_EDIT_BATCH_TOOL_SCHEMAS,
} from './tools/schemas/auto-edit-batch-tools';
...
export const TOOL_SCHEMAS: AgentToolSchema[] = [
  ...
  ...MUSIC_INTELLIGENCE_TOOL_SCHEMAS,
  ...AGENT_PATH_IMPORT_SCHEMAS,
  // Durable 10k-job auto-edit orchestration, isolated projects and local reference analysis.
  ...AUTO_EDIT_BATCH_TOOL_SCHEMAS,
...
const EXECUTOR_GROUPS: ReadonlyArray<readonly [ReadonlySet<string>, ToolExecutorLoader]> = [
  ...
  [AUTO_EDIT_BATCH_TOOL_NAMES, async () => (
    await import('./tools/auto-edit-batch-tools')
  ).execAutoEditBatchTool],
...
// validated args through executeYoloCutTool (or the shared invocation validator).
