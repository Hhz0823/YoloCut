...
const ROUTING_GROUPS: readonly RoutingGroup[] = [
  ...
  {
    requestKeywords: ['local voice', 'kokoro', '本地口播', '本地配音'],
    requestContext: [
      ['elevenlabs', 'doubao', 'minimax', 'inworld', 'fish audio', 'fishaudio', 'speechify', 'openai', 'gemini', 'mistral', 'cartesia', 'local', 'kokoro'],
