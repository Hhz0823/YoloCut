...
const DB_NAME = LEGACY_PERSISTENCE_IDS.mediaDatabase;
const STORE = 'blobs';
const DB_VERSION = 1;
const MAX_FILE_CACHE_BYTES = 200 * 1024 * 1024;
const MAX_TOTAL_CACHE_BYTES = 1024 * 1024 * 1024;
const MEDIA_AUTHORITY_HEADER = 'x-yolocut-media-authority';

const MEDIA_IMPORT_PREFIX = LEGACY_PERSISTENCE_IDS.mediaImportPrefix;
