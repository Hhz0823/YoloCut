...
const DB_NAME = LEGACY_PERSISTENCE_IDS.sharedDatabase;
const STORE = 'kv';
const MIGRATION_KEY = LEGACY_PERSISTENCE_IDS.sharedMigrationKey;
const PENDING_KEYS_KEY = LEGACY_PERSISTENCE_IDS.sharedPendingKeysKey;
