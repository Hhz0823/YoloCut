...
const row: CSSProperties = {
  padding: 10, background: theme.panelAlt, border: `1px solid ${theme.border}`, borderRadius: 4,
};
...
const rollbackButton: CSSProperties = {
  marginTop: 8, padding: '5px 10px', border: `1px solid ${theme.border}`, borderRadius: 4,
