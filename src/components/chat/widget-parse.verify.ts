...
const base = 'https://yolocut.local/editor';

assert.equal(safeWidgetMediaUrl('/media/preview.png', base), 'https://yolocut.local/media/preview.png');
assert.equal(safeWidgetMediaUrl('voice/sample.mp3', base), 'https://yolocut.local/voice/sample.mp3');
assert.equal(safeWidgetMediaUrl('blob:https://yolocut.local/id', base), 'blob:https://yolocut.local/id');
