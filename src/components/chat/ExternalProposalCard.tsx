  ...
  return (
    <div style={{ display: 'flex', gap: 8 }}>
      <button
        ...
        style={{ border: `1px solid ${theme.accent}`, background: 'none', color: theme.text, borderRadius: 6, padding: '5px 14px', fontSize: 12.5, cursor: 'pointer' }}
      >
        {t('确认')}
      </button>
      <button
        ...
        style={{ border: `1px solid ${theme.border}`, background: 'none', color: theme.textDim, borderRadius: 6, padding: '5px 14px', fontSize: 12.5, cursor: 'pointer' }}
      >
        {t('拒绝')}
      </button>
    </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        background: theme.panelAlt, border: `1px solid ${theme.accent}`,
      }}
    >
