...
export function ChatComposer(props: ChatComposerProps) {
  ...
  const inputAriaLabel = t('Agent 提示词输入');
  ...
  return (
    ...
    border: `1px solid ${theme.borderLight}`, borderRadius: 4,
    ...
    >
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4, marginBottom: 4 }} title={t('当前创作工作流，随消息发送')}>
          <span
            style={{
              ...
              fontSize: 11, lineHeight: 1.2, padding: '2px 6px', borderRadius: 8,
              background: theme.panel, border: `1px solid ${theme.accent}`, color: theme.text,
            }}
          >
      ...
      <textarea
        ...
        onPointerDown={(event) => {
          // Electron/Chromium can leave UI Automation focus on RootWebArea
          // when a controlled textarea is clicked inside a nested workbench.
          // Focus on pointer-down so desktop agents and keyboard users receive
          // a stable editable target before the click/default-focus sequence.
