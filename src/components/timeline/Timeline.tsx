...
export function Timeline(props: TimelineProps) {
  ...
  return (
    <section
      ...
      style={{ flex: 1, borderLeft: `1px solid ${theme.border}`, background: theme.bg, display: 'flex', flexDirection: 'column', minHeight: 0, overflow: 'hidden', position: 'relative' }}
    >
...
The playhead line/triangle is pointerEvents:none, click it to click the ruler - scrub the same path to take effect.*/}
      ...
      {clipJob && (
        <div style={{ position: 'fixed', left: '50%', bottom: 24, transform: 'translateX(-50%)', zIndex: 200,
          ...
          border: `1px solid ${theme.borderLight}`, borderRadius: 4, padding: '9px 16px', fontSize: 12.5,
