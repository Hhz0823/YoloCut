...
const PROJECT_REPOSITORY_URL = 'https://github.com/Hhz0823/yolocut';
...
export function DashboardHeaderLinks() {
  ...
  return (
    <span className="cc-dashboard-header-links" ref={contactRef} style={linkGroup}>
      <button
        type="button"
...
const contactPopover: CSSProperties = {
  ...
  border: `1px solid ${theme.border}`, borderRadius: 6, background: theme.panelAlt,
