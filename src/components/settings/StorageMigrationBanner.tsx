...
const primaryBtn: React.CSSProperties = {
  background: theme.panelAlt, border: `1px solid ${theme.borderLight}`, color: theme.textStrong, cursor: 'pointer',
  fontSize: 12.5, padding: '7px 14px', borderRadius: 8, whiteSpace: 'nowrap',
};
...
export function StorageMigrationBanner({ onOpenDialog }: { onOpenDialog: () => void }) {
  ...
  return (
    <div className="cc-storage-migration-banner" style={bannerStyle} role="status">
