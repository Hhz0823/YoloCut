...
function PreviewSection({ model }: { model: Model }) {
  ...
  return <section>
    ...
    <div style={{ background: bg, color: fg, borderRadius: 4, padding: '20px 22px', border: `1px solid ${theme.border}` }}>
...
const header: CSSProperties = { display: 'flex', alignItems: 'center', gap: 8, padding: '10px 12px', borderBottom: `1px solid ${theme.border}` };
const body: CSSProperties = { padding: '12px 12px 14px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 16 };
const footer: CSSProperties = { display: 'flex', flexDirection: 'column', gap: 8, padding: '10px 12px', borderTop: `1px solid ${theme.border}` };
...
const thumb: CSSProperties = { display: 'flex', width: 64, height: 36, borderRadius: 8, overflow: 'hidden', flexShrink: 0, border: `1px solid ${theme.border}` };
const noneThumb: CSSProperties = { ...thumb, background: theme.bg };
...
const colorRow: CSSProperties = { display: 'flex', alignItems: 'center', gap: 6, background: theme.panelAlt, border: `1px solid ${theme.border}`, borderRadius: 4, padding: '4px 7px' };
...
const textInput: CSSProperties = { width: '100%', background: theme.bg, color: theme.text, border: `1px solid ${theme.borderLight}`, borderRadius: 6, padding: '7px 9px', fontSize: 13, outline: 'none', boxSizing: 'border-box' };
const iconBtn: CSSProperties = { background: 'none', border: 'none', color: theme.textDim, cursor: 'pointer', padding: 3, lineHeight: 0 };
const ghostBtn: CSSProperties = { background: 'none', border: `1px solid ${theme.border}`, color: theme.text, borderRadius: 4, padding: '6px 14px', fontSize: 13, cursor: 'pointer' };
const primaryBtn: CSSProperties = { background: theme.panelAlt, border: `1px solid ${theme.borderLight}`, color: theme.textStrong, borderRadius: 8, padding: '7px 16px', fontSize: 13, fontWeight: 600, cursor: 'pointer' };
...
const fontMenu: CSSProperties = { position: 'absolute', top: '100%', left: 0, right: 0, marginTop: 4, zIndex: 5, maxHeight: 224, overflowY: 'auto', background: theme.panelAlt, border: `1px solid ${theme.border}`, borderRadius: 8, boxShadow: 'none', padding: '2px 0 6px' };
