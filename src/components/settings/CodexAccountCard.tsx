...
const card: React.CSSProperties = {
  ...
  background: theme.bg, border: `1px solid ${theme.border}`, borderRadius: 4,
};
...
const versionTag: React.CSSProperties = {
  flex: '0 0 auto', padding: '1px 5px', border: `1px solid ${theme.border}`,
...
const valueCode: React.CSSProperties = {
  display: 'block', minWidth: 0, overflow: 'hidden', color: 'inherit', fontFamily: 'SFMono-Regular, ui-monospace, SFMono-Regular, Menlo, monospace',
...
const button: React.CSSProperties = {
  minHeight: 28, padding: '4px 9px', border: `1px solid ${theme.border}`, borderRadius: 4,
...
const copyButton: React.CSSProperties = {
  ...
  padding: '2px 6px', border: `1px solid ${theme.border}`, borderRadius: 4,
  background: themeAlpha.ink(0.04), color: theme.textMuted, cursor: 'pointer', fontSize: 10,
};
const errorText: React.CSSProperties = {
  paddingTop: 7, borderTop: `1px solid ${theme.border}`, color: theme.danger,
