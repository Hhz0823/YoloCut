// Content plugin (yolocut-plugin@1) field type and upper limit. Design:docs/plugin-system-design.md.
...
//
// New packages use PLUGIN_FORMAT. The validation boundary also accepts the
// historical v1 identifier and normalizes it to this value; unknown formats
// remain fail-closed.

export const PLUGIN_FORMAT = 'yolocut-plugin@1';
