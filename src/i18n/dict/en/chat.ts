...
export default {
  ...
  // ── ChatPanel shell ──
  '展开 YoloCut Agent': 'Expand YoloCut Agent',
  '收起 YoloCut Agent': 'Collapse YoloCut Agent',
  '清空对话': 'Clear chat',
  ...
  '拖出为独立窗口': 'Detach into a window',
  '拖动工作台；拖到中间或窗口外可独立打开': 'Drag workspace; drop in the center or outside the window to detach',
  '停靠回剪辑器': 'Dock back into the editor',
  '未命名工程': 'Untitled project',
  '工程不存在，无法打开 Agent 工作台。': 'The project no longer exists, so the Agent workspace cannot be opened.',
  '加载 Agent 工作台…': 'Loading Agent workspace…',
  ...
  '批量自动剪辑': 'Batch auto edit',
  '最高 10,000 条': 'Up to 10,000 jobs',
  '投递素材目录、剪辑脚本、口播脚本和成片参考。每条素材建立独立工程，队列可暂停、恢复和失败重试。':
    'Provide a media folder, editing script, narration script, and finished-video reference. Each source gets an isolated project; the queue supports pause, resume, and failed-job retry.',
  '素材目录': 'Media folder',
  '选择目录并扫描，最多 10,000 条': 'Choose and scan a folder, up to 10,000 items',
  '{name} · {count} 条': '{name} · {count} items',
  '剪辑脚本': 'Editing script',
  '点击或拖入 txt / md / srt': 'Click or drop txt / md / srt',
  '口播脚本': 'Narration script',
  '独立于剪辑说明，供 TTS 与字幕使用': 'Separate from edit directions; used for TTS and captions',
  '成片参考': 'Finished-video reference',
  '只模仿结构、节奏、字幕与调色': 'Reuse structure, pacing, captions, and grading only',
  '已加入 {count} 个参考': '{count} reference(s) added',
  '开源参考分析': 'Open-source reference analysis',
  '未检测到模型包': 'Model pack not found',
  '模型未安装': 'Model not installed',
  'llama.cpp 未就绪': 'llama.cpp is not ready',
  '本地模型已就绪': 'Local model ready',
  '去设置': 'Open settings',
  '批量目录只在 YoloCut 桌面版可用。': 'Batch folders are available in the YoloCut desktop app only.',
  '脚本文件不能超过 2MB。': 'Script files cannot exceed 2 MB.',
  '脚本文件为空。': 'The script file is empty.',
  '成片参考必须是视频文件。': 'A finished-video reference must be a video file.',
  '批次已建立：{id}。提示词已放入输入框，请检查后发送。':
    'Batch created: {id}. Its prompt is in the composer; review it before sending.',
  '正在建立批次…': 'Creating batch…',
  '建立批次并交给 Agent': 'Create batch for Agent',
  '思考中…': 'Thinking…',
  'Agent 提示词输入': 'Agent prompt input',
