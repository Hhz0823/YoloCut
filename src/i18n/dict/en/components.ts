...
export default {
  '发现 YoloCut 新版本 {latest}，当前版本 {current}。请前往发布页查看。': 'YoloCut {latest} is available; current version: {current}. Visit the release page to review it.',
  ...
  '发现 YoloCut 新版本 {latest}，当前版本 {current}。可以直接下载并安装。': 'YoloCut {latest} is available; current version: {current}. Download and install it directly.',
  '正在下载 YoloCut {latest}：{percent}%': 'Downloading YoloCut {latest}: {percent}%',
  'YoloCut {latest} 已下载，重启后完成安装。': 'YoloCut {latest} is downloaded. Restart to finish installing.',
  '正在重启并安装 YoloCut…': 'Restarting to install YoloCut…',
  ...
  '安全框': 'Safe Area',
  '预览画布视图': 'Preview canvas view',
  '缩小预览画布': 'Zoom out preview canvas',
  '放大预览画布': 'Zoom in preview canvas',
  '适配预览画布': 'Fit preview canvas',
  '拖动平移预览画布': 'Drag to pan the preview canvas',
  '选择预览构图参考线': 'Select preview composition guide',
  '预览构图参考线': 'Preview composition guide',
  '参考线：关闭': 'Guides: Off',
  '标题 / 动作安全区': 'Title / Action Safe',
  '三分构图网格': 'Rule of Thirds',
  '预览画质': 'Preview quality',
  '自动': 'Auto',
  '高清': 'High quality',
  '流畅': 'Smooth',
  '高清：显示原始素材，画质最好，可能更吃性能': 'High quality: shows the original media (best quality; may use more CPU/GPU)',
  '自动：按本机 CPU、内存、GPU 和编解码能力选择流畅代理': 'Auto: select a smooth proxy from this computer\'s CPU, memory, GPU, and codec capabilities',
  '低配流畅档': 'Economy smooth tier',
  '均衡流畅档': 'Balanced smooth tier',
  ...
  '缓入出': 'Ease In-Out',
  '贝塞尔': 'Bezier',
  '最后一个关键帧没有后续曲线': 'The last keyframe has no outgoing curve',
  '打开关键帧曲线编辑器': 'Open keyframe curve editor',
  '关键帧曲线编辑器': 'Keyframe Curve Editor',
  '调整当前关键帧到下一关键帧的速度曲线': 'Adjust the timing curve from this keyframe to the next',
  '自定义': 'Custom',
  '贝塞尔速度曲线': 'Bezier timing curve',
  '控制点 {n}': 'Control point {n}',
  '完成': 'Done',
