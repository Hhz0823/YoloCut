...
function RegistryCard({ entry, installed, busyId, onInstall }: {
  ...
  return (
    <article style={{ border: `1px solid ${theme.border}`, background: theme.panelAlt, padding: 9, borderRadius: 5, display: 'flex', alignItems: 'center', gap: 9 }}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
      <div style={{ flex: 1, position: 'relative' }}>
        ...
        <input
          ...
          placeholder={t('搜索扩展…')}
          style={{ width: '100%', boxSizing: 'border-box', border: `1px solid ${theme.border}`, borderRadius: 4, background: theme.panelAlt, color: theme.text, padding: '6px 8px 6px 25px', fontSize: 11.5 }}
        />
      </div>
