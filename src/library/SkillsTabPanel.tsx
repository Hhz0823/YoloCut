    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0, overflowY: 'auto', padding: '12px 14px 18px', gap: 8 }}>
      ...
      {active && (
        <button
          ...
          style={{ textAlign: 'left', padding: '7px 10px', borderRadius: 6, border: `1px solid ${theme.accent}`, background: theme.panelAlt, cursor: 'pointer', color: theme.text }}
        >
      ...
      >
        ...
        <label style={{ display: 'flex', flexDirection: 'column', gap: 4, fontSize: 12 }}>
          ...
          <input
            ...
            style={{ padding: '5px 8px', borderRadius: 4, border: `1px solid ${theme.borderLight}`, background: theme.inset, color: theme.text, fontSize: 12 }}
          />
        </label>
        <label style={{ display: 'flex', flexDirection: 'column', gap: 4, fontSize: 12 }}>
          {t('说明')}
          <textarea
            ...
            rows={2}
            style={{ padding: '5px 8px', borderRadius: 4, border: `1px solid ${theme.borderLight}`, background: theme.inset, color: theme.text, fontSize: 12, resize: 'vertical' }}
          />
        </label>
        <label style={{ display: 'flex', flexDirection: 'column', gap: 4, fontSize: 12 }}>
          ...
          <textarea
            ...
            rows={14}
            style={{
              padding: '7px 9px', borderRadius: 4, border: `1px solid ${theme.borderLight}`,
