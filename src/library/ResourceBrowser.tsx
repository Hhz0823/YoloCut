  ...
  return (
    <button
      ...
      style={{
        ...
        flexDirection: 'column', gap: 3, padding: '9px 11px', border: `1px solid ${theme.border}`,
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        {item.badge && <span style={{ fontSize: 9, color: theme.accent, border: `1px solid ${theme.accent}`, borderRadius: 3, padding: '0 3px' }}>{t(item.badge)}</span>}
      </div>
