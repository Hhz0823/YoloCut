...
const toolbarButton: CSSProperties = {
  ...
  border: `1px solid ${theme.border}`, borderRadius: 5, cursor: 'pointer', fontSize: 11,
};
...
const textarea: CSSProperties = {
  ...
  border: `1px solid ${theme.border}`, borderRadius: 5, background: theme.inset,
  color: theme.text, padding: '7px 8px', font: 'inherit', fontSize: 11, outline: 'none',
};
const primaryButton: CSSProperties = {
  border: `1px solid ${theme.borderLight}`, borderRadius: 8, padding: '6px 9px', background: theme.panelAlt,
  color: theme.textStrong, fontSize: 11, fontWeight: 600, cursor: 'pointer',
};
const smallButton: CSSProperties = {
  border: `1px solid ${theme.border}`, borderRadius: 4, padding: '3px 7px',
  background: 'transparent', color: theme.textDim, fontSize: 10, cursor: 'pointer',
};
const commentCard: CSSProperties = {
  padding: 9, marginBottom: 7, border: `1px solid ${theme.border}`,
...
const replyInput: CSSProperties = {
  minWidth: 0, flex: 1, border: `1px solid ${theme.border}`, borderRadius: 4,
...
const errorRow: CSSProperties = {
  padding: '7px 10px', borderTop: `1px solid ${theme.border}`, color: theme.danger, fontSize: 10,
};
