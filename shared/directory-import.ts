...
export const AGENT_PATH_IMPORT_CHANNEL = 'yolocut:agent-path-import';

export const DIRECTORY_IMPORT_CHANNELS = {
  start: 'yolocut:directory-import-start',
  activate: 'yolocut:directory-import-activate',
  acknowledge: 'yolocut:directory-import-acknowledge',
  stop: 'yolocut:directory-import-stop',
  imported: 'yolocut:directory-import-file',
} as const;
